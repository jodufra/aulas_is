...
namespace ConsoleApplicationOOP
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                customers.Add(new Customer("A Customer", i.ToString(), new DateTime((1975 + i), 1, 1), "my a customer address"));
                customers.Add(new Customer("B Customer", i.ToString(), new DateTime((2000 + i), 1, 1), "my b customer address"));
            }
